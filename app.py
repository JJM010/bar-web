...
def cerrar_dia():
    ...
    # evitar duplicados de días cerrados
    cursor.execute("SELECT * FROM dias_cerrados WHERE fecha=?", (fecha,))
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO dias_cerrados (fecha) VALUES (?)", (fecha,))
        conn.commit()
